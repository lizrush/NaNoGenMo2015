...
with open('./books/uncle_toms_cabin.txt', 'r') as content_file:
...
input = [sentences, "xxBeGiN142xx", "xxEnD142xx", "data://.algo/ngram/GenerateTrigramFrequencies/temp/trigrams-toms.txt"]
